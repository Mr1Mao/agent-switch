"""agent_core hooks 子包：事件枚举、Context、结果模型与基类。"""
...
from agent_core.hooks.result import INTERCEPTABLE_HOOK_EVENTS, HookOutcome, HookResult
...
import agent_core.types.config as _agent_config_module
