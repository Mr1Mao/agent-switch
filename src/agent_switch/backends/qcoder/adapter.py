...
from agent_switch.logging import get_logger
from agent_switch.types import AgentChunk, AgentConfig, AgentMessage, AgentResponse, MessageRole

_logger = get_logger("agent_switch.backends.qcoder")
...
class QcoderAdapter(BaseAgentAdapter):
    ...
    def _query_impl(self) -> Any:
        ...
        from qoder_agent_sdk import query  # 延迟导入：import agent_switch 不加载 SDK
